...
* After refering some papers, we found "rank"and "exper", may be effect measure modifiers of the association between gender and salary. Then we use anova to test the interaction.
